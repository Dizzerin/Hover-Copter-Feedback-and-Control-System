...
%   
%   This v0.4 of the script uses a new model (not the model from v1) to model the
...
%   The controller feeback gain parameters are set two ways in this script, first
